...
analyze_input_mockdict = {
	...
	INPUT2 : (QUES2, FORMULA2, NOTE2)
}

get_data_mockdict = {
	(FORMULA1, NOTE1) : DATAPOINTS1,
	(FORMULA2, NOTE2) : DATAPOINTS2
}
...
def get_data(formula: str, patient_note: str) -> list[str]:
	"""Accepts a formula and a patient note, and extracts datapoints from the patient note required to evaluate the rule.
	"""
	...
...
def medcalc_formulas(input_str):
	...
	datapoints = get_data(formula, patient_note)
